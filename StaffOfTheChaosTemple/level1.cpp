...
Level1::Level1(b2World* world, int screenWidthCamera, int screenHeightCamera) : Level::Level(world, screenWidthCamera, screenHeightCamera)
{
	...
	AddChild(wall3);
	wall4 = new B2Entity(camera, ResourceManager::GetShader("defaultShader"), world);
	wall4->CreateBodyBox(960, 0, 1920, 100, glm::vec2(0.0f, 0.0f), false, false, true);
	wall4->GiveTexture(ResourceManager::GetTexture("wall"));
	AddChild(wall4);
	wall5 = new B2Entity(camera, ResourceManager::GetShader("defaultShader"), world);
	...
	AddChild(wall5);
	wall6 = new B2Entity(camera, ResourceManager::GetShader("defaultShader"), world);
	...
	door = new Door(Direction::west, camera, ResourceManager::GetShader("defaultShader"), world);
	door->CreateBodyBox(840, 1080, 240, 100, glm::vec2(0, 0), false, false, true);
	door->GiveTexture(ResourceManager::GetTexture("player"));
	door->Link(crystal);
	door->Link(crystal2);
	AddChild(door);
	door2 = new Door(Direction::east, camera, ResourceManager::GetShader("defaultShader"), world);
