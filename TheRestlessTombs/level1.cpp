...
Level1::Level1(Player* player, Shop* shop, b2World* world, ResourceManager* rm, Input* input, Camera* camera) : Scene::Scene(camera) {
	...
	necromancerOrc2_1 = new NecromancerOrc(1.5f, this->player, 900.0f, this->rm, this->camera, rm->GetShader("person"), this->world);
	...
	orc3_1 = new Orc(this->player, 600.0f, this->rm, this->camera, this->rm->GetShader("person"), this->world);
	orc3_1->CreateBody(692, -50, 50, 75);
	orc3_1->GiveTexture(this->rm->GetTexture("orc"));
	orc3_1->GiveItem(gold3_1);
	orc3_2 = new Orc(this->player, 600.0f, this->rm, this->camera, this->rm->GetShader("person"), this->world);
	...
	bomberOrc4_1 = new BomberOrc(this->player, 450.0f, this->rm, this->camera, this->rm->GetShader("person"), this->world);
	bomberOrc4_1->CreateBody(2774, -825, 50, 57);
	bomberOrc4_1->GiveTexture(this->rm->GetTexture("bomberOrc"));
	bomberOrc4_1->GiveItem(bomb4_1);
	bomberOrc4_2 = new BomberOrc(this->player, 450.0f, this->rm, this->camera, this->rm->GetShader("person"), this->world);
	...
	psychoOrc4_1 = new PsychoOrc(this->player, 550.0f, this->rm, this->camera, this->rm->GetShader("person"), this->world);
	...
	armoredOrc5_1 = new ArmoredOrc(this->player, 500.0f, this->rm, this->camera, this->rm->GetShader("person"), this->world);
	...
	armoredOrc5_2 = new ArmoredOrc(this->player, 500.0f, this->rm, this->camera, this->rm->GetShader("person"), this->world);
	...
	necromancerOrc6_1 = new NecromancerOrc(1.5f, this->player, 1200.0f, this->rm, this->camera, rm->GetShader("person"), this->world);
	...
	babyOrc6_1 = new BabyOrc(this->player, 1200.0f, this->rm, this->camera, this->rm->GetShader("person"), this->world);
	babyOrc6_1->CreateBody(-998, -1700, 50, 50);
	babyOrc6_1->GiveTexture(this->rm->GetTexture("babyOrc"));
	babyOrc6_2 = new BabyOrc(this->player, 1200.0f, this->rm, this->camera, this->rm->GetShader("person"), this->world);
	babyOrc6_2->CreateBody(-938, -1700, 50, 50);
	babyOrc6_2->GiveTexture(this->rm->GetTexture("babyOrc"));
	babyOrc6_3 = new BabyOrc(this->player, 1200.0f, this->rm, this->camera, this->rm->GetShader("person"), this->world);
	babyOrc6_3->CreateBody(-818, -1700, 50, 50);
	babyOrc6_3->GiveTexture(this->rm->GetTexture("babyOrc"));
	babyOrc6_4 = new BabyOrc(this->player, 1200.0f, this->rm, this->camera, this->rm->GetShader("person"), this->world);
	...
	bossOrc7_1 = new BossOrc("BossOrc", this->player, 1000.0f, this->rm, this->camera, this->rm->GetShader("person"), this->world);
