 ...
 * @file armoredOrc.h
 *
 * @brief The armoredOrc header file.
 */
...
/**
 * @brief The ArmoredOrc class
 */
class ArmoredOrc : public Enemy {
public:
	/// @brief Constructor of the AmoredOrc takes a Camera and Shader that is used for rendering and a B2World for the B2Body
	...
	/// @brief Destructor of the ArmoredOrc
	~ArmoredOrc();
	...
	/// @brief Apply damage to a ArmoredOrc the damage goes minus the health
	/// @param damage The amount of damage the person will take the damage goes minus the health
	/// @return void
	void TakeDamage(int damage);

	/// @brief Reset the ArmoredOrc to it's begin values
	/// @return void
	void Reset();
private:
	Weapon* sword; ///< @brief sword Is the weapon used by the ArmoredOrc
};
