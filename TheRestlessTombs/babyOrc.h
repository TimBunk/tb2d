...
/**
 * @brief The BabyOrc class
 */
class BabyOrc : public Enemy {
public:
	/// @brief Constructor of the BabyOrc takes a Camera and Shader that is used for rendering and a B2World for the B2Body
	...
	/// @brief Destructor of the babyOrc
	~BabyOrc();
	...
	/// @brief Reset the BabyOrc to it's begin values
	/// @return void
	void Reset();
private:
	Weapon* sword; ///< @brief sword Is the weapon used by the BabyOrc
};
